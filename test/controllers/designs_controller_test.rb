...
class DesignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post designs_url, params: { design: { deadline: @design.deadline, email: @design.email, name: @design.name, order: @design.order, phone: @design.phone } }
    end
  ...
  test "should update design" do
    patch design_url(@design), params: { design: { deadline: @design.deadline, email: @design.email, name: @design.name, order: @design.order, phone: @design.phone } }
